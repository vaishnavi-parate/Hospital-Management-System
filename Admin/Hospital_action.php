...
{
$id=$_POST['id'];
$delete = "DELETE FROM doctor_registration WHERE HID='$id'";
mysql_query( $delete);
...
{
$id=$_POST['ide'];
mysql_query("UPDATE doctor_registration SET Apprve = 'YES' WHERE  HID=".$id."");
...
<h4 class="margin-bottom-15">All Hospital</h4>
...
$dval=$_SESSION['Duserid'];
					...
					$per_page = 10; 
					$select_table = "select * from doctor_registration where concat(Hospital_head_name,' ',Hospital_name,' ',Hospital_contact) like '%".$Cdateval."%'";
...
$select_table =$select_table." order by HID DESC limit $start,$per_page";
$fetch= mysql_query($select_table);
}
...
<TD><?php echo $row["Hospital_head_name"]; ?></TD>
<TD><?php echo $row["Hospital_name"]; ?></TD>
<TD><?php echo $row["Hospital_username"]; ?></TD>
<TD><?php echo $row["Hospital_speciality"]; ?></TD>
...
{
?>
<a href="#" class="Edit" id="<?php echo $row["HID"]; ?>"><button class="btn btn-sm btn-primary">[ Approve ]</button></a>
<?php
}
?>                                                          
<a href="#" class="ABCD" id="<?php echo $row["HID"]; ?>"><button class="btn btn-sm btn-danger">
                                                          [ Delete ]</button></a>
														  </TD> 													  </TD> 
</TR>

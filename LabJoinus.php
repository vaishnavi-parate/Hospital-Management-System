...
$("#btn").click(function() {
				...
				$("#regform").ajaxForm({
						...
						<h1>Lab Registration Form</h1>
						<p><div id="show"></div>
	                    </p>
	                    <form role="form" action="Labregister.php" method="post" enctype="multipart/form-data" id="regform">
						<input type="hidden" value="saverec" name="saverec">
	                    	<div class="form-group">
	                    		<label for="contact-name">Lab Technician Name</label>
	                        	<input type="text" name="LTN" class="contact-name" id="contact-name">
	                        </div>
	                    	<div class="form-group">
	                    		<label for="contact-email">Lab Name</label>
	                        	<input type="text" name="LN"  class="contact-email" id="contact-email">
	                        </div>
	                        <div class="form-group">
	                        	<label for="contact-subject">Lab Email</label>
	                        	<input type="text" name="LUN"  class="contact-subject" id="contact-subject">
	                        </div>
							<div class="form-group">
                        ...
                        <div class="form-group">
	                        	<label for="contact-subject">Lab Speciality(Eg. Cancer,Skin...)</label><br>
	                        	<Textarea name="LSPE" class="contact-subject" id="contact-subject"></Textarea>
	                        </div>

	                        <div class="form-group">
	                        	<label for="contact-subject">Lab Contact No</label>
	                        	<input type="text" name="LCN"  class="contact-subject" id="contact-subject">
	                        </div>
